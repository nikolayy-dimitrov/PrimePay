    ...
    return <section id="home" className="gap-16 py-10 md:h-full md:pb-0 bg-white">
            ...
            <div className="mt-12 z-10">
                ...
                <div className="relative flex items-end justify-center h-screen">
                    <div className="absolute inset-0 flex justify-center items-center">
                        <img alt="home-page-hero-background" src={HeroBackground} className="w-11/12 h-screen max-md:hidden"/>
                        <img alt="money-icon" src={MoneyImg} className="absolute size-52 left-[25%] bottom-[10%] max-md:hidden" />
                        <img alt="money-icon" src={CardImg} className="absolute size-36 right-[25%] bottom-[5%] max-md:hidden" />
                    </div>
        ...
        <div className="flex items-center justify-center h-screen">
            <div className="absolute bg-bgc w-11/12 rounded-3xl md:h-5/6">
                ...
                <div className="flex items-end justify-center h-full">
                    <div className="grid md:grid-cols-3 bottom-10 gap-8 pb-32 p-6">
        ...
        <div>
            <div className="flex w-10/12">
                <div className="font-Jost font-semibold text-2xl">
                    ...
                    <p className="font-OpenSans font-normal text-sm text-balance">
                        Lorem ipsum dolor sit amet, consectetur
                        adipisicing elit, sed do eiusmod tempor incididunt</p>
                    <p className="font-OpenSans font-normal text-sm text-wrap">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <div className="border-gray-line mt-2 rounded-3xl w-1/2 border bg-gray-line"></div>
                    <div className="flex items-center justify-center gap-4">
                        <div className="shadow flex justify-center items-center border border-orange-300 bg-orange-300 rounded-3xl h-10 w-10"></div>
                        <h5 className="text-sm font-OpenSans font-bold">Lorem Ipsum Dolor Sit</h5>
                    </div>
                </div>
                <div className="flex">
                    <img alt="backgrond-image" src={BackgroundThird} className="rounded-3xl" />
                </div>
            </div>
        </div>
    </section>
