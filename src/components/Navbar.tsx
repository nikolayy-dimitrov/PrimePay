...
const Navbar = ({ selectedPage, setSelectedPage }: Props) => {
    ...
    return <nav>
        <div className="flex items-center justify-between fixed top-0 z-30 w-full py-4">
            <div className="flex items-center justify-between mx-auto">
                <div className="flex items-center justify-between gap-52 w-full">
                    <a href="/home"><img alt="PrimePay Logo" src={Logo} className=""/></a>
                    ...
                    <div className="flex justify-center items-center w-full gap-32">
                        ...
                        <div className="mx-auto border rounded-3xl border-primary bg-primary text-white pl-8 pr-8 p-4">
